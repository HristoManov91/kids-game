...
- регистрация и вход с 14-дневна сесия
- възстановяване на забравена парола с еднократен email линк
...
APP_PASSWORD_RESET_TTL_MINUTES=30
APP_PASSWORD_RESET_DELIVERY=log
...
При локална разработка reset линкът се изписва в backend лога. За изпращане по email задай
`APP_PASSWORD_RESET_DELIVERY=smtp` и SMTP променливите `APP_SMTP_HOST`, `APP_SMTP_PORT`,
`APP_SMTP_USERNAME`, `APP_SMTP_PASSWORD`, `APP_MAIL_FROM`, `APP_SMTP_AUTH` и `APP_SMTP_STARTTLS`.
Съществуващите профили могат да добавят recovery email от екрана „Профил“; новите регистрации го изискват.
...
APP_TOKEN_TTL_HOURS=336
APP_PASSWORD_RESET_DELIVERY=smtp
APP_FRONTEND_BASE_URL=https://your-app.example
APP_SMTP_HOST=smtp.example.com
APP_SMTP_PORT=587
APP_SMTP_USERNAME=your-smtp-user
